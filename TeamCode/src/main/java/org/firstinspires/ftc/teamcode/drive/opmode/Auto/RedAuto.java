...
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.Random.left;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE1_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE1_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE1_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE1_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE1_PRE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE1_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE1_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE2_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE2_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE2_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE2_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE2_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE2_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.CYCLE2_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.PARK;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.PRELOAD_YELLOW;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.PRELOAD_YELLOW_DROP;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.PRELOAD_YELLOW_INTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.SPIT1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.RedAuto.State.SPIT2;
...
//                .splineTo(new Vector2d(32, 36), Math.toRadians(90))
        ...
        TrajectorySequence preload2_v1_5 = drive.trajectorySequenceBuilder(preload1.end())
                ...
                .splineTo(new Vector2d(49.5, 30.5), Math.toRadians(89))
                .build();
        ...
        TrajectorySequence cycle2_v1 = drive.trajectorySequenceBuilder(deposit_v1.end())
                .setReversed(false)
                .splineTo(new Vector2d(49.5, -10), Math.toRadians(89))
                .splineTo(new Vector2d(49.5, 31.75), Math.toRadians(89))
                .build();
        ...
        TrajectorySequence deposit_v1_2 = drive.trajectorySequenceBuilder(cycle2_v1.end())
                .setReversed(true)
                .lineToConstantHeading(new Vector2d(49.5, -10))
                .lineToConstantHeading(new Vector2d(26, -38))
                .build();
        ...
        while (opModeIsActive() && !isStopRequested()) {
            switch(state){
                ...
                case CYCLE1_INTER1:
                    ...
                    if((timer.seconds() > 0.3 && Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 50) || timer.seconds() > 0.5){
                        timer.reset();
                        state = SPIT1;
                    }
                    break;
                ...
                case CYCLE2_INTAKE:
                    ...
                    if((timer.seconds() > 0.2 && Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 50) || timer.seconds() > 0.5){
                        timer.reset();
                        state = CYCLE2_INTER2;
                    }
                    break;
