...
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.Random.left;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE1_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE1_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE1_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE1_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE1_PRE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE1_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE1_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE2_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE2_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE2_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE2_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE2_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE2_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE2_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE3_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE3_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE3_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE3_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE3_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.CYCLE3_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.PARK;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.PRELOAD_YELLOW;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.PRELOAD_YELLOW_DROP;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.PRELOAD_YELLOW_INTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.SPIT1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTest.State.SPIT2;
...
@Autonomous(name="meet 3 auto test")
public class Meet3AutoTest extends LinearOpMode {
    OpenCvWebcam webcam;
    ...
    public static double c2pos = 0.44;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence preload1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(25, 37, Math.toRadians(-60)))
//                .splineTo(new Vector2d(20, 33), Math.toRadians(90))
//                .splineTo(new Vector2d(20, 37), Math.toRadians(90))
                .build();
...
//                })
        ...
        TrajectorySequence deposit_v2 = drive.trajectorySequenceBuilder(preload2_v2_5.end())
                ...
                .lineToConstantHeading(new Vector2d(26, 36.25))
                .build();
        ...
        TrajectorySequence cycle2_v2 = drive.trajectorySequenceBuilder(deposit_v2.end())
                .setReversed(false)
                .splineTo(new Vector2d(48.75, 10), Math.toRadians(-91.75))
                .splineTo(new Vector2d(48.75, -32), Math.toRadians(-91.75))
                .build();
        ...
        TrajectorySequence deposit_v1_3 = drive.trajectorySequenceBuilder(deposit_v1_2.end())
                .setReversed(true)
                .splineTo(new Vector2d(49, 10), Math.toRadians(90))
                .splineTo(new Vector2d(34, 36.25), Math.toRadians(-250))
                .build();
        ...
        while (opModeIsActive() && !isStopRequested()) {
            switch(state){
                ...
                case CYCLE1_PRE:
                    ...
                    if(timer.seconds() > 0.05 && Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 50){
                        if(result == Barcode.LEFT){
                ...
                case CYCLE1_INTER1:
                    if((Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 50) || timer.seconds() > 0.25){
                        timer.reset();
                        state = SPIT1;
                    }
                    break;
                ...
                case CYCLE1_INTER2:
                    ...
                    if(timer.seconds() > 0.3 && Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 500){
                        if(result == Barcode.LEFT){
