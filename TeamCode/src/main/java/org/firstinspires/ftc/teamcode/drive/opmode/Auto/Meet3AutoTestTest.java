...
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.Random.left;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE1_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE1_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE1_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE1_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE1_PRE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE1_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE1_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE2_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE2_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE2_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE2_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE2_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE2_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE2_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE3_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE3_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE3_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE3_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE3_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE3_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.CYCLE3_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.PARK;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.PRELOAD_YELLOW;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.PRELOAD_YELLOW_DROP;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.PRELOAD_YELLOW_INTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.SPIT1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3AutoTestTest.State.SPIT2;
...
@Autonomous(name="meet 3 auto test test")
public class Meet3AutoTestTest extends LinearOpMode {
    OpenCvWebcam webcam;
    ...
    public static double c1pos = 0.56;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence preload2 = drive.trajectorySequenceBuilder(startPose)
                ...
                .setReversed(true)
                .back(4)
                .splineTo(new Vector2d(25, 37), Math.toRadians(90))
                .build();
        ...
        TrajectorySequence preload2_v1_5 = drive.trajectorySequenceBuilder(preload1.end())
                .setReversed(false)
                .splineTo(new Vector2d(49, 18), Math.toRadians(-91.25))
                .splineToLinearHeading(new Pose2d(49, -30.5, Math.toRadians(-91.25)), Math.toRadians(270))
                .build();

        TrajectorySequence preload2_v2_5 = drive.trajectorySequenceBuilder(preload2.end())
                .setReversed(false)
                .splineTo(new Vector2d(48, 10), Math.toRadians(-91.75))
                .splineTo(new Vector2d(48, -30.5), Math.toRadians(-91.75))
                .build();
...
//                .splineTo(new Vector2d(34, 37), Math.toRadians(-250))
        ...
        TrajectorySequence cycle2_v1 = drive.trajectorySequenceBuilder(deposit_v1.end())
                .setReversed(false)
                .splineTo(new Vector2d(50, 18), Math.toRadians(-91.25))
                .splineTo(new Vector2d(50, -30.5), Math.toRadians(-91.25))
                .build();

        TrajectorySequence cycle2_v2 = drive.trajectorySequenceBuilder(deposit_v2.end())
                .setReversed(false)
                .splineTo(new Vector2d(51, 10), Math.toRadians(-91.75))
                .splineTo(new Vector2d(51, -32), Math.toRadians(-91.75))
                .build();
...
//                .splineTo(new Vector2d(34, 37), Math.toRadians(-250))
        ...
        TrajectorySequence cycle3_v1 = drive.trajectorySequenceBuilder(deposit_v1_2.end())
                .setReversed(false)
                .splineTo(new Vector2d(51, 18), Math.toRadians(-91.25))
                .splineTo(new Vector2d(51, -30.5), Math.toRadians(-91.25))
            ...
            switch(state){
                ...
                case PRELOAD_YELLOW_INTER:
                    ...
                    if(timer.seconds() > 0.75){
                        ppos = Range.clip(-0.00603*(angle)+pposadd, 0.02, 0.6);
                    }
                ...
                case SPIT2:
                    ...
                    if((intake1 && intake2)||timer.seconds() > 0.5){
                        intake1 = false;
                        intake2 = false;
                        timer.reset();
                        state = CYCLE1_INTER2;
                ...
                case CYCLE1_TRANSFER1:
                    ...
                    //here
                    if(timer.seconds() > 1.95){
                        Otarget = -200;
                    }

                    if(timer.seconds() > 2.15){
                        intakePower = 0;
                        Otarget = -300;
                        c1pos = 0.56;
                        c2pos = 0.42;
