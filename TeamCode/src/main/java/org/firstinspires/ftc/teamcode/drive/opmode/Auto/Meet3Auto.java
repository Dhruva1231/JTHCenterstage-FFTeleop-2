...
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.Random.left;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE1_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE1_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE1_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE1_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE1_PRE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE1_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE1_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE2_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE2_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE2_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE2_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE2_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE2_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.CYCLE2_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.PARK;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.PRELOAD_YELLOW;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.PRELOAD_YELLOW_DROP;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.PRELOAD_YELLOW_INTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.SPIT1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Auto.State.SPIT2;
...
//                })
        ...
        TrajectorySequence preload2_v1_5 = drive.trajectorySequenceBuilder(preload1.end())
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(50, 18), Math.toRadians(-91.75))
                .lineToConstantHeading(new Vector2d(50, -30.5))
                .build();
        ...
        TrajectorySequence deposit_v1 = drive.trajectorySequenceBuilder(preload2_v1_5.end())
                .setReversed(true)
                .splineTo(new Vector2d(50, 10), Math.toRadians(91.75))
                .splineTo(new Vector2d(38, 36.25), Math.toRadians(-225))
                .build();
        ...
        TrajectorySequence cycle2_v1 = drive.trajectorySequenceBuilder(deposit_v1.end())
                .setReversed(false)
                .splineTo(new Vector2d(50, 18), Math.toRadians(-91.75))
                .splineTo(new Vector2d(50, -30.5), Math.toRadians(-91.75))
                .build();
...
//                        frontgrab.setPosition(0.4);
                ...
                case CYCLE1_PRE:
                    ...
                    if(timer.seconds() > 0.5 && Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 50){
                        if(result == Barcode.LEFT){
                ...
                case CYCLE1_INTER1:
                    ...
                    if((timer.seconds() > 0.3 && Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 50) || timer.seconds() > 1){
                        timer.reset();
                        state = SPIT1;
                    }
                    break;
                ...
                case SPIT2:
                    ...
                    if((intake1 && intake2)||timer.seconds() > 0.1){
                        timer.reset();
                        state = CYCLE1_INTER2;
                ...
                case CYCLE1_INTER2:
                    ...
                    if(timer.seconds() > 1 && Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 50){
                        if(result == Barcode.LEFT){
