...
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.Random.left;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE1_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE1_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE1_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE1_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE1_PRE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE1_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE1_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE2_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE2_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE2_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE2_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE2_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE2_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE2_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE3_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE3_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE3_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE3_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE3_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE3_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.CYCLE3_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.PARK;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.PRELOAD_YELLOW;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.PRELOAD_YELLOW_DROP;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.PRELOAD_YELLOW_INTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.SPIT1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.Meet3Red2Cycle.State.SPIT2;
...
@Autonomous(name="meet 3 red auto 2 cycle")
public class Meet3Red2Cycle extends LinearOpMode {
    OpenCvWebcam webcam;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence preload1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineTo(new Vector2d(28, 6), Math.toRadians(40))
        ...
        TrajectorySequence preload3 = drive.trajectorySequenceBuilder(startPose)
                .lineToLinearHeading(new Pose2d(23, -17, Math.toRadians(45)))
                .addDisplacementMarker(() -> {
                    frontgrab.setPosition(0.4);
                })
                .setReversed(true)
        ...
        TrajectorySequence preload2_v1_5 = drive.trajectorySequenceBuilder(preload1.end())
                .setReversed(false)
                .splineTo(new Vector2d(49.5, -10), Math.toRadians(89))
                .splineTo(new Vector2d(49.5, 31.5), Math.toRadians(89))
                .build();
        ...
        TrajectorySequence deposit_v1 = drive.trajectorySequenceBuilder(preload2_v1_5.end())
                .setReversed(true)
                .lineToConstantHeading(new Vector2d(49.5, -10))
                .lineToConstantHeading(new Vector2d(26, -34.5))
                .build();
