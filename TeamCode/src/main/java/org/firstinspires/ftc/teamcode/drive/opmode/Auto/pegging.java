...
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.pegging.State.newpreload9_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.pegging.State.newpreload9_75;
...
//                .splineTo(new Vector2d(25, -10), Math.toRadians(0))
                .splineToLinearHeading(new Pose2d(41.5, -20, Math.toRadians(-66)), Math.toRadians(0))
...
//                })
        ...
        TrajectorySequence preload3 = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineTo(new Vector2d(39.5, -20), Math.toRadians(-55))
...
//                .lineToLinearHeading(new Pose2d(50, -8, Math.toRadians(-90)))
                ...
                .setReversed(true)
                .splineTo(new Vector2d(50, 50), Math.toRadians(95))
                .splineToConstantHeading(new Vector2d(23.5, 84.75), Math.toRadians(95))
                .build();
...
//                .lineToLinearHeading(new Pose2d(50, -8, Math.toRadians(-90)))
                ...
                .setReversed(true)
                .splineTo(new Vector2d(50, 50), Math.toRadians(95))
                .splineToConstantHeading(new Vector2d(28, 85.25), Math.toRadians(95))
                .build();
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            switch(state){
                ...
                case newpreload2:
                    ...
                    if(timer.seconds() > 0.45 && result == Barcode.RIGHT){
                        wristpos = 1;
                    }
                    if(!drive.isBusy() && (result == Barcode.MIDDLE||result == Barcode.RIGHT)){
                        timer.reset();
                        state = newpreload3;
                    }
