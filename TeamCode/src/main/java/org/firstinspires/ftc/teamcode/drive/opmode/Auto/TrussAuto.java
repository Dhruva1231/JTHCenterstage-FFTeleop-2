...
//                })
                .setReversed(true)
                .back(2)
                .splineTo(new Vector2d(27, 39), Math.toRadians(90))
                .build();
...
//                .splineTo(new Vector2d(28, 38), Math.toRadians(90))
                .lineToLinearHeading(new Pose2d(32, 39, Math.toRadians(-90)))
                .build();
...
//                .splineTo(new Vector2d(-1, 18), Math.toRadians(-93))
//                .splineTo(new Vector2d(-1, -40), Math.toRadians(-93))
//                .splineTo(new Vector2d(19, -50), Math.toRadians(-93))
//                .splineTo(new Vector2d(19, -68.5), Math.toRadians(-93))
                .splineTo(new Vector2d(-1, 18), Math.toRadians(-93))
                .lineTo(new Vector2d(-1, -40))
                .splineTo(new Vector2d(14.5, -67.85), Math.toRadians(-80))
...
//                .splineTo(new Vector2d(-1, 18), Math.toRadians(-93))
//                .splineTo(new Vector2d(-1, -40), Math.toRadians(-93))
//                .splineTo(new Vector2d(8, -53), Math.toRadians(-70))
...
//                .splineTo(new Vector2d(2.5, 43.5), Math.toRadians(45))
        ...
        TrajectorySequence cycle3_v1 = drive.trajectorySequenceBuilder(deposit_v1_2.end())
                ...
                //                .splineTo(new Vector2d(-9, -40), Math.toRadians(-93))
...
//                .splineTo(new Vector2d(19, -68.5), Math.toRadians(-93))
        ...
        TrajectorySequence deposit_v1_3 = drive.trajectorySequenceBuilder(cycle3_v1.end())
                .setReversed(true)
                .splineTo(new Vector2d(-9, -40), Math.toRadians(93))
                .splineTo(new Vector2d(-9, 18), Math.toRadians(93))
                .splineTo(new Vector2d(-1, 40), Math.toRadians(70))
                .build();
