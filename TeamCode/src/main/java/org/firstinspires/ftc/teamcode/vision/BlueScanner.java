...
public class BlueScanner extends OpenCvPipeline {
    ...
    Rect leftROI = new Rect(new Point(2.7 * 1280/4, 275), new Point(3 * 1280 / 4.0, 475));
    Rect midROI = new Rect(new Point(2.65 * 1280 / 4.0, 925), new Point(3.15 * 1280 / 4.0, 1080));
    Rect rightROI = new Rect(new Point(3.9 * 1280 / 4.0, 1000), new Point(1280, 1080));
    ...
    public Mat processFrame(Mat input) {
        ...
        if (leftValue>midValue && (leftValue>100000)) {
            result = Barcode.LEFT;
        ...
        } else if (midValue>leftValue && (midValue > 100000)) {
