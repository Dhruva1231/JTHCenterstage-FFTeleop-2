...
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_PRE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_REATTEMPT1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_REATTEMPT2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_REATTEMPT3;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_TRANSFER1_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_TRANSFER3;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_TRANSFER4;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE1_TRANSFERINTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_TRANSFER1_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_TRANSFER3;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE2_TRANSFERINTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_DEPOSIT;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_INTAKE;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_INTER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_INTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_INTER_5;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_TRANSFER1;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_TRANSFER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_TRANSFER3;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_TRANSFERINTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.CYCLE3_TRANSFERINTER2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.PRELOAD_YELLOW;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.PRELOAD_YELLOW_DROP;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.PRELOAD_YELLOW_INTER;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.SPIT2;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.State.SPIT3;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.flip.betweenflip;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.flip.initializeflip;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.flip.intake2flip;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.flip.intake3flip;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.flip.intake4flip;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.flip.intake5flip;
import static org.firstinspires.ftc.teamcode.drive.opmode.Auto.NewStatesAutoRed.flip.transferflip;
...
@Autonomous(name="new new states auto red ")
public class NewStatesAutoRed extends LinearOpMode {
    OpenCvWebcam webcam;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence preload1 = drive.trajectorySequenceBuilder(startPose)//
                ...
                .splineTo(new Vector2d(23, 4), Math.toRadians(65))
                .waitSeconds(0.1)
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(34.5, -39.5, Math.toRadians(95)))
                .build();
        ...
        TrajectorySequence preload2_v1_5 = drive.trajectorySequenceBuilder(preload1.end())
                ...
                .splineTo(new Vector2d(48, -20.5), Math.toRadians(-95))
                .build();
        ...
        TrajectorySequence cycle2_v1 = drive.trajectorySequenceBuilder(deposit_v1.end())
                .setReversed(false)
                .splineTo(new Vector2d(47.5, 18), Math.toRadians(-94.5))
                .splineTo(new Vector2d(47.5, -20), Math.toRadians(-94.5))
                .build();
...
//                        state = CYCLE1_INTAKE;
                ...
                case CYCLE1_TRANSFERINTER:
                    if(timer.seconds() > 0.5 && Math.abs(intakeLeftExt.getCurrentPosition() - Ltarget) < 75){
                ...
                case CYCLE1_TRANSFER3:
                    if(timer.seconds() > 0.4){
                        if(intSensor1.isPressed() && intSensor2.isPressed()){
                            timer.reset();
                            state = CYCLE1_REATTEMPT1;
                        }
                    }
                    if(timer.seconds() > 0.5) {
                        flip = intake3flip;
